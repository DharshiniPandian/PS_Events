      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            {showReason && <td>{registrationData.rejectionReason || 'N/A'}</td>} 
            {showSubmitButton && <td><Link to={`/reportSubmissionForm/${registrationData.eventName}`} ><button onClick={handleSubmit}>Submit</button></Link></td>}
          </tr>
        </tbody>
      </table>
    </div>
